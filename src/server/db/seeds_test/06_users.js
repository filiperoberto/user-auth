...
exports.seed = function(knex, Promise) {
    return knex('ck_users').insert([
        ...
        { id : 2, username : 'yoda@jedi.com', password : '0aee08b69285710fcda2ec80cf83eb816ae74ba7', created : null, modified : null, name : 'Yoda', website : '', description : '', picture: '', reputition : 0, email : 'yoda@jedi.com'}
    ]);
}